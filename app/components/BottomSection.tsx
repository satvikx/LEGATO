...
return (
    <section className="w-full py-10 md:py-15 lg:py-20 bg-gray-100">
          <div className="container px-4 md:px-6">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl text-center mb-12">Features</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 py-4">
              <div className="flex flex-col items-center text-center py-2">
                <Flame className="h-12 w-12 mb-4 text-primary" />
              ...
              <div className="flex flex-col items-center text-center py-2">
                <MusicIcon className="h-12 w-12 mb-4 text-primary" />
              ...
              <div className="flex flex-col items-center text-center py-2">
              <TabletSmartphone className="h-12 w-12 mb-4 text-primary" />
            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[600px] text-gray-300 md:text-xl">
                    A Full-Stack Developer who loves to code and build amazing products.
                </p>
              </div>
            </div>
          </div>
